...
3. Sign in with your Pixiv account. Mokona opens Pixiv's own login page; your password never goes through the app.
...
| 🖼️ See | 🔍 Find | 🎨 Live |
| --- | --- | --- |
| Home with your account's recommendations | Daily, weekly, monthly rankings, by audience, originals and rookies | Material You: the palette comes from your wallpaper (Android 12+) |
| Staggered grid with every work's real proportion, 1 to 4 columns | Tag search with trending tags one tap away | Light, dark or system theme, plus **AMOLED black** for OLED screens |
| Detail with every page, translated tags, related works and original download | Bookmarks from the app, synced with your account | R-18 content **off by default**, switchable in Settings › Content |
...
- Login is the Pixiv app's own (OAuth with PKCE): Mokona opens the official page in a WebView and only receives the code back. **It never sees your password.**
